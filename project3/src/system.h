...
private:
    ...
    class vec3  				m_linearMomentum    = vec3(0,0,0);
    class vec3					m_angularMomentum   = vec3(0,0,0);
...
public:
    ...
    void printIntegrateInfo     (int stepNumber, int printModulus);
